...
if __name__ == '__main__':
    def init_trainer(dynamic_lr, batch_size=12):
        trainer = Sentiment_trainer(max_seq_len=170,
    ...
    for epoch in range(start_epoch, start_epoch + train_epoches):
        if epoch == start_epoch and epoch == 0:
            ...
            trainer.load_model(trainer.bert_model, dir_path="process/bert_state_dict", load_bert=True)
