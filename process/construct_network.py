...
from util_network import read_qts, get_alter_names_from_CBDB
...
def main():
  ...
  parser.add_argument('--qts_path', type=str, default='../data/json_zh/qts_zht.txt',
                      help='file path of Quan Tangshi')
  parser.add_argument('--cbdb_path', type=str, default='../data/cbdb_sqlite.db',
                      help='file path of CBDB')
  parser.add_argument('--save_dir', type=str, default='save_Skip1',
