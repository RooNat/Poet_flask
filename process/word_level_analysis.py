...
def word2vec(words_file):
    ...
    if os.path.exists(vector_file):
        ...
        print('计算词向量')
        model=Word2Vec(LineSentence(words_file),vector_size=400,window=8,min_count=10,sg=0,
...
def print_stat_results(char_counter, author_counter, genre_counter,vector_model):
    ...
    # print_similar_words('高兴',vector_model)
    # print_similar_words('悲伤',vector_model)

def tangmain(qts_path,words_path):
